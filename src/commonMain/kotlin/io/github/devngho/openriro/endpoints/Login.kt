...
import io.github.devngho.openriro.client.OpenRiroAPIImpl
 ...
 * 로그인 요청
 *
 * 이 요청을 사용하는 대신 [OpenRiroAPIImpl]과 `login`을 사용하는 것을 권장합니다.
 */
object Login: Request<AuthConfig, Login.LoginResponse> {
    @Serializable
    ...
    override suspend fun execute(client: OpenRiroAPI, request: AuthConfig): Result<LoginResponse> = client.retry {
